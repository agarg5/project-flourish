...
- ✅ M3: build & steward menu, click-to-place, procedural eco-futurist building architecture, construction grow-in, player-confirmed age-up
...
Buildings are procedural eco-futurist ("solarpunk") architecture, generated in Three.js (`src/render/buildingArt.tsx`) — no external model assets.
